...
_Standard JavaScript `if` statements and `&&` operators do not connect to Retend's reactivity system when the data changes. Use `If` for conditional interface content that can change._
